...
export default function Confirmacao() {
  ...
  const handleConfirmar = async () => {
    ...
    if (senha === '$3nh4Teste' && dataNascimento === '2003-08-22') {
    ...
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: '#e8f0f7' }}>
      ...
      <div className="flex-1 max-w-7xl w-full mx-auto px-6 py-8">
        ...
        <div className="flex flex-col lg:flex-row gap-6 mb-6">
          ...
          <div className="bg-white rounded-xl border border-gray-200 overflow-hidden w-full lg:w-80 lg:flex-shrink-0 h-fit">
      ...
      {modalAberto && (
        <ModalConfirmacao
          ...
          mensagem="Para concluir a matrícula, informe novamente sua senha e data de nascimento."
          onConfirmar={handleConfirmar}
          onCancelar={() => setModalAberto(false)}
          confirmando={validando}
          confirmarDesabilitado={!senha || !dataNascimento}
        >
